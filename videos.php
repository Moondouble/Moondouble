...
<div id="btn-group">
        ...
        <hr>
        <br>
        <iframe width="400" height="225" src="https://www.youtube.com/embed/<?php echo $result1['Main_Video']; ?>"  frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="margin:auto;"></iframe>
    <br><br>
    ...
    <hr>
    <br>
    <iframe width="400" height="225" src="https://www.youtube.com/embed/<?php echo $result2['Main_Video']; ?>" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="margin:auto;"></iframe>
    <br><br>
